...
function PeterARicketti() {
  return (
    <SleepDoctorPage
      ...
      moreInfoLink={"http://www.mercerallergyandpulmonary.com/"}
      note={
        "Note for patient to schedule for sleep care. There are two Dr. Ricketti’s at the office make sure you ask for Dr. Peter Ricketti who is specialist in Sleep Medicine. The other Dr. Ricketti, Dr. Anthony Ricketti does not see/treat sleep related patient"
      }
    />
  );
}

export default PeterARicketti;
