...
function SleepDisorders() {
  return (
    <div>
      ...
      <div className="p-8 md:px-12 flex flex-col gap-8">
        <div className="text-primary-light mt-4 flex flex-row flex-wrap justify-center gap-8 text-center text-2xl">
          <LinkCard
            text="AASM Patient Guides"
            link="https://aasm.org/clinical-resources/patient-info/patient-friendly-guidelines/"
          />
          <LinkCard
            text="AASM - Sleep Education"
            link="https://sleepeducation.org/?__hstc=3531631.8fc3c4a03ed87e488aab7023384a306d.1715110953350.1754282858402.1754331445036.41&__hssc=3531631.18.1754331445036&__hsfp=3923671493"
          />
          <LinkCard
            text="Sleep FAQs"
            link="https://sleepeducation.org/sleep-faqs/"
          />
          <LinkCard
            text="Printable Sleep Diary"
            link="https://sleepeducation.org/resources/sleep-diary/"
          />
        </div>
